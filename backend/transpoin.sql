...
-- Dumping data for table transpoin.layanan: ~2 rows (approximately)
INSERT INTO `layanan` (`id`, `deskripsi`, `jenis`, `status`, `tanggal`, `admin_id`, `user_id`) VALUES
	...
	(2, 'Tadi ada bus Trans Metro Bandung ugal ugalan dijalan, plat nomor bus nya D 1234 OB', 'Pengaduan', 'DIPROSES', '2026-06-03', NULL, 2);
...
INSERT INTO `perjalanan` (`id`, `asal`, `jarak`, `poin_didapat`, `tanggal`, `tujuan`, `admin_id`, `user_id`, `bukti_perjalanan`, `catatan`, `status`, `halte_asal_id`, `halte_tujuan_id`) VALUES
	...
	(11, NULL, 4.1, 4, '2026-06-03', NULL, 5, 2, 'uploads/bukti/61c02eab-1863-4e78-b764-d94cd17999dc.jpg', NULL, 'APPROVED', 2, 1);
...
-- Dumping data for table transpoin.reward: ~1 rows (approximately)
